...
var debugAddr = fs.String("debug.addr", ":6080", "Debug and metrics listen address")
var httpAddr = fs.String("http-addr", ":6081", "HTTP listen address")
var grpcAddr = fs.String("grpc-addr", ":6082", "gRPC listen address")
var thriftAddr = fs.String("thrift-addr", ":6083", "Thrift listen address")
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "curriculum")
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterCurriculumServer(baseServer, grpcServer)
