...
var fs = flag.NewFlagSet("message", flag.ExitOnError)
...
var grpcAddr = fs.String("grpc-addr", ":7082", "gRPC listen address")
var thriftAddr = fs.String("thrift-addr", ":7083", "Thrift listen address")
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "message")
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterMessageServer(baseServer, grpcServer)
